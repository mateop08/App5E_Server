...
type VehicleMembershipTypesFields = 'Code' | 'Description'
...
const generateValidationToVehicleMembershipType = (fields: VehicleMembershipTypesFields[]) => {
    return validationGenerator(fields, validations)
}

export default generateValidationToVehicleMembershipType
...
type OfimaDocumentTypesFields = 'User'
...
const generateValidationToOfimaDocumentType = (fields: OfimaDocumentTypesFields[]) => {
    return validationGenerator(fields, validations)
}

export default generateValidationToOfimaDocumentType
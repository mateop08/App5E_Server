...
type DocumentTypesFields = 'Code' | 'Description'
...
const generateValidationToDocumentType = (fields: DocumentTypesFields[]) => {
    return validationGenerator(fields, validations)
}

export default generateValidationToDocumentType
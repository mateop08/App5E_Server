...
type VehicleFuelTypesFields = 'Code' | 'Description'
...
const generateValidationToVehicleFuelType = (fields: VehicleFuelTypesFields[]) => {
    return validationGenerator(fields, validations)
}

export default generateValidationToVehicleFuelType
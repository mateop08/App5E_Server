...
type VehiclePlateTypesFields = 'Code' | 'Description'
...
const generateValidationToVehiclePlateType = (fields: VehiclePlateTypesFields[]) => {
    return validationGenerator(fields, validations)
}

export default generateValidationToVehiclePlateType